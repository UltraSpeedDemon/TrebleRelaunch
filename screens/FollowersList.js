  ...
  const loadNotifications =
    useCallback(async () => {
      ...
      try {
        ...
        console.error(
          "[FollowersList] Notifications error:",
          error
        );
            ...
            privateUsers.map(
              async (user) => {
                try {
                  ...
                  console.warn(
                    `[FollowersList] Request-status error for ${user.userId}:`,
                    error
                  );
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              People following your Treble profile.
            </Text>
          ...
          {loading ? (
            ...
            <FlatList
              ...
              key={`${followersList}-grid-${gridColumns}`}
              columnWrapperStyle={
                styles.userTileRow
              }
              renderItem={
              ...
              ListEmptyComponent={
                ...
                >
                  ...
                  >
                    {errorMessage ||
                      "When someone follows your account, they will appear here."}
                  </Text>
                </View>
              }
            />
