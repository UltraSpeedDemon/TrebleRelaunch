    ...
    return Promise.all(
      reviewItems.map(async (reviewItem) => {
        ...
        try {
          ...
          console.warn(
            "[ArtistPage] Could not load review user:",
            error
          );
   ...
   // Share modal
    ...
    const handleShareComment = async () => {
      ...
      try {
        ...
        console.error("[ArtistPage] Share error:", error);
  ...
  const handleAddReview = () => {
    ...
    openConfirmation({
      title: isUpdating
        ...
        : "Post Artist Review?",
      message: isUpdating
        ? "Are you sure you want to update this artist review?"
